...
namespace Gnu.Inet.Encoding
{
    ...
    public class RFC3454
    {
        ...
        /// The b 2 replace.
        /// </summary>
        public static string[] B2replace =
        {
            "\u0061", /*0041; 0061; Case map*/
            "\u0062", /*0042; 0062; Case map*/
            "\u0063", /*0043; 0063; Case map*/
        ...
        /// The b 3 replace.
        /// </summary>
        public static string[] B3replace =
        {
            "\u0061", /*0041; 0061; Case map*/
            "\u0062", /*0042; 0062; Case map*/
            "\u0063", /*0043; 0063; Case map*/
        ...
        /// The c 21.
        /// </summary>
        public static char[][] C21 =
        {
            new[] {'\u0000', '\u001F'}, /* 0000-001F; [CONTROL CHARACTERS] */
            new[] {'\u007F'} /* 007F; DELETE */
        };
        ...
        /// The c 22.
        /// </summary>
        public static char[][] C22 =
        {
            new[] {'\u0080', '\u009F'}, /* 0080-009F; [CONTROL CHARACTERS] */
            new[] {'\u06DD'}, /* 06DD; ARABIC END OF AYAH */
            new[] {'\u070F'}, /* 070F; SYRIAC ABBREVIATION MARK */
            new[] {'\u180E'}, /* 180E; MONGOLIAN VOWEL SEPARATOR */
            new[] {'\u200C'}, /* 200C; ZERO WIDTH NON-JOINER */
            new[] {'\u200D'}, /* 200D; ZERO WIDTH JOINER */
            new[] {'\u2028'}, /* 2028; LINE SEPARATOR */
            new[] {'\u2029'}, /* 2029; PARAGRAPH SEPARATOR */
            new[] {'\u2060'}, /* 2060; WORD JOINER */
            new[] {'\u2061'}, /* 2061; FUNCTION APPLICATION */
            new[] {'\u2062'}, /* 2062; INVISIBLE TIMES */
            new[] {'\u2063'}, /* 2063; INVISIBLE SEPARATOR */
            new[] {'\u206A', '\u206F'}, /* 206A-206F; [CONTROL CHARACTERS] */
            new[] {'\uFEFF'}, /* FEFF; ZERO WIDTH NO-BREAK SPACE */
            new[] {'\uFFF9', '\uFFFC'} /* FFF9-FFFC; [CONTROL CHARACTERS] */
        };
        ...
        {
            new[] {'\uE000', '\uF8FF'} /* E000-F8FF; [PRIVATE USE, PLANE 0] */
        };
        ...
        {
            new[] {'\uFDD0', '\uFDEF'}, /* FDD0-FDEF; [NONCHARACTER CODE POINTS] */
            new[] {'\uFFFE', '\uFFFF'} /* FFFE-FFFF; [NONCHARACTER CODE POINTS] */
        };
        ...
        {
            new[] {'\uFFF9'}, /* FFF9; INTERLINEAR ANNOTATION ANCHOR */
            new[] {'\uFFFA'}, /* FFFA; INTERLINEAR ANNOTATION SEPARATOR */
            new[] {'\uFFFB'}, /* FFFB; INTERLINEAR ANNOTATION TERMINATOR */
            new[] {'\uFFFC'}, /* FFFC; OBJECT REPLACEMENT CHARACTER */
            new[] {'\uFFFD'} /* FFFD; REPLACEMENT CHARACTER */
        };
        ...
        {
            new[] {'\u2FF0', '\u2FFB'} /* 2FF0-2FFB; [IDEOGRAPHIC DESCRIPTION CHARACTERS] */
        };

        /// <summary>
        /// The c 8.
        /// </summary>
        public static char[][] C8 =
        {
            new[] {'\u0340'}, /* 0340; COMBINING GRAVE TONE MARK */
            new[] {'\u0341'}, /* 0341; COMBINING ACUTE TONE MARK */
            new[] {'\u200E'}, /* 200E; LEFT-TO-RIGHT MARK */
            new[] {'\u200F'}, /* 200F; RIGHT-TO-LEFT MARK */
            new[] {'\u202A'}, /* 202A; LEFT-TO-RIGHT EMBEDDING */
            new[] {'\u202B'}, /* 202B; RIGHT-TO-LEFT EMBEDDING */
            new[] {'\u202C'}, /* 202C; POP DIRECTIONAL FORMATTING */
            new[] {'\u202D'}, /* 202D; LEFT-TO-RIGHT OVERRIDE */
            new[] {'\u202E'}, /* 202E; RIGHT-TO-LEFT OVERRIDE */
            new[] {'\u206A'}, /* 206A; INHIBIT SYMMETRIC SWAPPING */
            new[] {'\u206B'}, /* 206B; ACTIVATE SYMMETRIC SWAPPING */
            new[] {'\u206C'}, /* 206C; INHIBIT ARABIC FORM SHAPING */
            new[] {'\u206D'}, /* 206D; ACTIVATE ARABIC FORM SHAPING */
            new[] {'\u206E'}, /* 206E; NATIONAL DIGIT SHAPES */
            new[] {'\u206F'} /* 206F; NOMINAL DIGIT SHAPES */
        };
