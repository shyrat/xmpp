...
namespace XMPP.Tags.Jabber.Protocol.Activity
{
    ...
    {
        public const string XmlNamespace = "http://jabber.org/protocol/activity";

        public static readonly XName Activity = XName.Get("activity", XmlNamespace);
        public static readonly XName DoingChores = XName.Get("doing_chores", XmlNamespace);
        public static readonly XName Drinking = XName.Get("drinking", XmlNamespace);
        public static readonly XName Eating = XName.Get("eating", XmlNamespace);
        public static readonly XName Exercising = XName.Get("exercising", XmlNamespace);
        public static readonly XName Grooming = XName.Get("grooming", XmlNamespace);
        public static readonly XName HavingAppointment = XName.Get("having_appointment", XmlNamespace);
        public static readonly XName Inactive = XName.Get("inactive", XmlNamespace);
        public static readonly XName Relaxing = XName.Get("relaxing", XmlNamespace);
        public static readonly XName Talking = XName.Get("talking", XmlNamespace);
        public static readonly XName Traveling = XName.Get("traveling", XmlNamespace);
        public static readonly XName Working = XName.Get("working", XmlNamespace);
        public static readonly XName Text = XName.Get("text", XmlNamespace);
        public static readonly XName AtTheSpa = XName.Get("at_the_spa", XmlNamespace);
        public static readonly XName BrushingTeeth = XName.Get("brushing_teeth", XmlNamespace);
        public static readonly XName BuyingGroceries = XName.Get("buying_groceries", XmlNamespace);
        public static readonly XName Cleaning = XName.Get("cleaning", XmlNamespace);
        public static readonly XName Coding = XName.Get("coding", XmlNamespace);
        public static readonly XName Commuting = XName.Get("commuting", XmlNamespace);
        public static readonly XName Cooking = XName.Get("cooking", XmlNamespace);
        public static readonly XName Cycling = XName.Get("cycling", XmlNamespace);
        public static readonly XName DayOff = XName.Get("day_off", XmlNamespace);
        public static readonly XName DoingMaintenance = XName.Get("doing_maintenance", XmlNamespace);
        public static readonly XName DoingTheDishes = XName.Get("doing_the_dishes", XmlNamespace);
        public static readonly XName DoingTheLaundry = XName.Get("doing_the_laundry", XmlNamespace);
        public static readonly XName Driving = XName.Get("driving", XmlNamespace);
        public static readonly XName Gaming = XName.Get("gaming", XmlNamespace);
        public static readonly XName Gardening = XName.Get("gardening", XmlNamespace);
        public static readonly XName GettingAHaircut = XName.Get("getting_a_haircut", XmlNamespace);
        public static readonly XName GoingOut = XName.Get("going_out", XmlNamespace);
        public static readonly XName HangingOut = XName.Get("hanging_out", XmlNamespace);
        public static readonly XName HavingABeer = XName.Get("having_a_beer", XmlNamespace);
        public static readonly XName HavingASnack = XName.Get("having_a_snack", XmlNamespace);
        public static readonly XName HavingBreakfast = XName.Get("having_breakfast", XmlNamespace);
        public static readonly XName HavingCoffee = XName.Get("having_coffee", XmlNamespace);
        public static readonly XName HavingDinner = XName.Get("having_dinner", XmlNamespace);
        public static readonly XName HavingLunch = XName.Get("having_lunch", XmlNamespace);
        public static readonly XName HavingTea = XName.Get("having_tea", XmlNamespace);
        public static readonly XName Hiking = XName.Get("hiking", XmlNamespace);
        public static readonly XName InACar = XName.Get("in_a_car", XmlNamespace);
        public static readonly XName InAMeeting = XName.Get("in_a_meeting", XmlNamespace);
        public static readonly XName InRealLife = XName.Get("in_real_life", XmlNamespace);
        public static readonly XName Jogging = XName.Get("jogging", XmlNamespace);
        public static readonly XName OnABus = XName.Get("on_a_bus", XmlNamespace);
        public static readonly XName OnAPlane = XName.Get("on_a_plane", XmlNamespace);
        public static readonly XName OnATrain = XName.Get("on_a_train", XmlNamespace);
        public static readonly XName OnATrip = XName.Get("on_a_trip", XmlNamespace);
        public static readonly XName OnThePhone = XName.Get("on_the_phone", XmlNamespace);
        public static readonly XName OnVacation = XName.Get("on_vacation", XmlNamespace);
        public static readonly XName Other = XName.Get("other", XmlNamespace);
        public static readonly XName Partying = XName.Get("partying", XmlNamespace);
        public static readonly XName PlayingSports = XName.Get("playing_sports", XmlNamespace);
        public static readonly XName Reading = XName.Get("reading", XmlNamespace);
        public static readonly XName Rehearsing = XName.Get("rehearsing", XmlNamespace);
        public static readonly XName Running = XName.Get("running", XmlNamespace);
        public static readonly XName RunningAnErrand = XName.Get("running_an_errand", XmlNamespace);
        public static readonly XName ScheduledHoliday = XName.Get("scheduled_holiday", XmlNamespace);
        public static readonly XName Shaving = XName.Get("shaving", XmlNamespace);
        public static readonly XName Shopping = XName.Get("shopping", XmlNamespace);
        public static readonly XName Skiing = XName.Get("skiing", XmlNamespace);
        public static readonly XName Sleeping = XName.Get("sleeping", XmlNamespace);
        public static readonly XName Socializing = XName.Get("socializing", XmlNamespace);
        public static readonly XName Studying = XName.Get("studying", XmlNamespace);
        public static readonly XName Sunbathing = XName.Get("sunbathing", XmlNamespace);
        public static readonly XName Swimming = XName.Get("swimming", XmlNamespace);
        public static readonly XName TakingABath = XName.Get("taking_a_bath", XmlNamespace);
        public static readonly XName TakingAShower = XName.Get("taking_a_shower", XmlNamespace);
        public static readonly XName Walking = XName.Get("walking", XmlNamespace);
        public static readonly XName WalkingTheDog = XName.Get("walking_the_dog", XmlNamespace);
        public static readonly XName WatchingTv = XName.Get("watching_tv", XmlNamespace);
        public static readonly XName WatchingAMovie = XName.Get("watching_a_movie", XmlNamespace);
        public static readonly XName WorkingOut = XName.Get("working_out", XmlNamespace);
        public static readonly XName Writing = XName.Get("writing", XmlNamespace);
    }
